...
new fields "Match to Financial statements EU / Debit" and "... / Credit" that allow you to
...
The new menu item "Accounting / Reporting / Financial statements EU" allows you to select the period and
choose how to export the EU financial statements.
The following generation options are present in the "Financial statements EU" wizard:
